...
int main() {
	...
	int arr3[] = { 6, 7, 8, 9, 10 }; // 배열 크기 생략하고 초기화

	// 배열의 길이
	cout << "arr의 길이: " << sizeof(arr) / sizeof(arr[0]) << endl;
	// c++ 17이후로는 std::size(arr)로 배열의 길이를 구할 수 있습니다.
